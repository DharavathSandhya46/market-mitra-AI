...
const tips = [
  "💡 Add products using voice — just tap the mic!",
  "📊 AI will suggest best-selling items for your area",
  "🔔 Get alerts when stock is running low",
  "📈 Track daily sales with smart charts",
];
      ...
      {showTips && (
        <div className="absolute top-6 right-6 z-20 glass-card p-4 max-w-xs animate-slide-in-left">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-display font-semibold text-foreground">Quick Tips</span>
            <button
          ...
          <ul className="space-y-2">
            {tips.map((tip, i) => (
              <li
                key={i}
                className="text-xs text-secondary-foreground/80 animate-fade-in-up"
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-scale-in">
        <div className="glass-card-strong p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-display font-bold gradient-text">MarketMitra AI</h1>
            <p className="text-sm text-muted-foreground">Smart inventory for smart shopkeepers</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-xl bg-primary text-primary-foreground font-semibold font-display flex items-center justify-center gap-2 hover:brightness-110 active:scale-[0.98] transition-all duration-200 glow-primary"
            >
              Sign In
